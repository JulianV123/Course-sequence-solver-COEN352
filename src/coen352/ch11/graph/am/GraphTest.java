...
/**
 * GraphTest.java was given to us on moodle
 */
   ...
   
{
	...
	static List<Integer> DFS_nonrecursive(Graph g, int v) {
	 ...
	 */
		...
		*/
		 ...
		 */
		static List<Integer> topsortQueue(Graph G) { // Topological sort: Queue
			  ADTQueue<Integer> Q = new AQueue<Integer>(G.n());
			  List<Integer> list = new LinkedList<>();
	 ...
	 // @Test
	  ...
	  public void testDFS() throws IOException {
			...
			assertEquals( "0pre 1pre 3pre 4pre 5pre 2pre ", out.toString());
	  }
